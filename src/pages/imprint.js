...
const ImprintPage = ({ intl }) => {
  return (
    <Layout>
      ...
      <div lang="de"></div>
        <PageSection content={{ heading: intl.formatMessage({ id: "imprint.imprintHeading" }) }} >
          <TextSection>
            <FormattedMessage 
              id="imprint.imprintContent" 
              values={{
                h3: (...chunks) => <h3>{chunks}</h3>,
                p: (...chunks) => <p>{chunks}</p>,
                // linebreak: <br />,
                // linkMailto: <a href="mailto:mail@felixberger.dev">mail@felixberger.dev</a>,
                // linkContentsourceImprint: <a href='https://www.e-recht24.de'>https://www.e-recht24.de</a>,
              }}
            />
          </TextSection>
        </PageSection>

        <PageSection content={{ heading: 'Datenschutz' }} >
          <TextSection>
            ...
            <ul>
              <li>Verarbeitete Datenarten: Bestandsdaten (z.B. Namen, Adressen), Kontaktdaten (z.B. E-Mail, Telefonnummern), Inhaltsdaten (z.B. Texteingaben, Fotografien, Videos).</li>
            ...
            <p>Wir setzen ein "Content-Delivery-Network" (CDN) ein. Ein CDN ist ein Dienst, mit dessen Hilfe Inhalte eines Onlineangebotes, insbesondere große Mediendateien, wie Grafiken oder Programm-Skripte, mit Hilfe regional verteilter und über das Internet verbundener Server schneller und sicherer ausgeliefert werden können.</p>
            <ul>
            ...
            <p>Quelle: <a href="https://datenschutz-generator.de/?l=de">https://datenschutz-generator.de</a></p>
          </TextSection>
        </PageSection>
    </Layout>
  )
